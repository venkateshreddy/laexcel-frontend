...
export const PreAdmission = {
  ...
  FETCH_ALL_ASSIGNED_ENQUIRIES: 'FETCH_ALL_ASSIGNED_ENQUIRIES'
};
...
export const Admission = {
  FETCH_ALL_ADMISSIONS: 'FETCH_ALL_ADMISSIONS',
  CREATE_ADMISSION: 'CREATE_ADMISSION',
  SET_ADMISSION_INFORMATION: 'SET_ADMISSION_INFORMATION',
  SET_GENERAL_INFORMATION: 'SET_GENERAL_INFORMATION',
  PREFIL_GENERAL_INFORMATION: 'PREFIL_GENERAL_INFORMATION',
  SETSTATE_ADDRESS_INFORMATION: 'SETSTATE_ADDRESS_INFORMATION',
  SETSTATE_ADDRESS_INFORMATION_ERRORS: 'SETSTATE_ADDRESS_INFORMATION_ERRORS',
  SETSTATE_EDUCATION_INFORMATION: 'SETSTATE_EDUCATION_INFORMATION',
  SET_OTHER_INFORMATION: 'SET_OTHER_INFORMATION',
  SET_PROGRAM_INFORMATION: 'SET_PROGRAM_INFORMATION'
};
